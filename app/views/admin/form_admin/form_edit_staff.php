    ...
    <form role="form" action="" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
            ...
            <a href="#" class="thumbnail" >
                <img style="width: 20%; dislay: block;" width="80%" height="100px" src="images/<?php echo $k_image?>" alt="<?php echo $k_image?>">
            </a>
		...
		<div class="form-group">
            <label>Role :</label>
            <select class="form-control" name="k_role" required>
