...
if(isset($_GET['kursus_name']))
{
    $kursus_name = $_GET['kursus_name'];
}

    $query = query("SELECT * FROM kigsb_kursus WHERE kursus_name = '{$kursus_name}'");
    confirm($query);
?>

<h2 style="font-family: Berlin Sans FB; font-color: black; text-align: center;  font-size: 30px"><?php echo $kursus_name ?></h2>
<div class='container'>
    <div class='row'>
