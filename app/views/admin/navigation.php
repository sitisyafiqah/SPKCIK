...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
  ...
  <br>
		  ...
		  <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Charts">
          <a class="nav-link" href="?pages=senarai_staff">
    ...
    confirm($query);
          ...
          <ul class="sidenav-second-level collapse" id="collapseparlimen">
			  ...
			  <li>
				<a href="?pages=parlimen&k_parlimen=Pasir Puteh">Pasir Puteh</a>
			</li>
			  <li>
			  ...
			  <li>
				<a href="?pages=parlimen&k_parlimen=Bachok">Bachok</a>
			</li>
			  <li>
      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
			<a href="?pages=logout" class="nav-link" data-toggle="modal" data-target="#exampleModal">
