...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  <!-- Navigation-->
<?php require VIEW_ROOT . '/admin/navigation.php'; ?>
...
-->
      <div class="row">
        <div class="col-12">
			...
			}elseif($pages_url == "kursus_baru")
			{
				require VIEW_ROOT . '/admin/form_admin/form_kursus.php';
				
			}elseif($pages_url == "tambah_tahun")
			{
				require VIEW_ROOT . '/admin/form_admin/form_tahun.php';
			...
			}elseif($pages_url == "tambah_staff")
			{
				require VIEW_ROOT . '/admin/form_admin/form_add_staff.php';
				
			}elseif($pages_url == "edit_staff")
			{
				require VIEW_ROOT . '/admin/form_admin/form_edit_staff.php';
				
			}elseif($pages_url == "senarai_staff")
			{
				require VIEW_ROOT . '/admin/form_admin/form_list_staff.php';
			...
			}elseif($pages_url == "daftar")
			{
				require VIEW_ROOT . '/staff/form_staff/form_daftar.php';
			...
			}elseif($pages_url == "kursus")
			{
				require VIEW_ROOT . '/admin/form_admin/form_list_kpeserta.php';
			}
